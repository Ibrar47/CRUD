...
if (isset($_POST["submit"])) {
   ...
   echo $sql = "UPDATE `crud` SET `first_name`='$first_name',`last_name`='$last_name',`email`='$email',`gender`='$gender' WHERE ID='$ID'";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: index.php?msg=Date update successfully");
   } else {
